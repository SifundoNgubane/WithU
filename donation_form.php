                        ...
                        <div class="input-group">
                            ...
                            <div class="rs-select2 js-select-simple select--no-search">
                                <select id="mode"  name="mode" onchange='changeAction(this.value)'>
                                    ...
                                    <option value="bank.php">RSA Banks</option>
                                    <option value="<?php echo $action; ?>">PayuMoney</option>
                                    <option value="crypto.php">cryptocurrency</option>
                                    <option value="https://paypal.me/kairobrands?country.x=ZA&locale.x=en_US">PayPal</option>
