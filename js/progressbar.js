...
window.onload = function() {
    ...
    donationNumber.innerHTML = "R" + User.donationCollect;
    donationGoal.innerHTML = "Goal<br>$" + User.donationGoal;
    donationStatus.innerHTML = "<i class='fa fa-window-close red'></i> You need <span class='red'>R" + (User.donationGoal - User.donationCollect) + "</span> to reach your Donation Goal";

    // Events

    // Only Positive Numbers allowed in the Donation input
    ...
    donate.onclick = function(e) {
        ...
        donationNumber.innerHTML = "R" + newDonationNumber;
        donationProgress.setAttribute("style", "width:" + newPercent + "%");
        donationNumber.setAttribute("style", "left:" + newPercent + "%");
        donationStatus.innerHTML = User.donationGoal - newDonationNumber > 0 ? "<i class='fa fa-window-close red'></i> You need <span class='red'>R" + (User.donationGoal - newDonationNumber) + "</span> to reach your Donation Goal" : "<i class='fa fa-exclamation-circle green'></i> Your campaign has been funded";
